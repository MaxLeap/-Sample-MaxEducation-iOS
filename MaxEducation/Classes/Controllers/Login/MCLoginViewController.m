...
//    [self.qqLoginButton setImage:[UIImage imageNamed:@"ic_qq"] forState:UIControlStateNormal];
...
//            [[NSNotificationCenter defaultCenter] postNotificationName:kLoginSuccessNofitification object:nil];
            [self.telInputTextField resignFirstResponder];
            [self.passcodeInputTextField resignFirstResponder];
...
//            登录IM： 同一个SMS code使用一次作废，所以无法登录用户系统和IM系统
//            [[MaxChatIMClient sharedInstance].client loginWithPhoneNumber:self.telInputTextField.text
//                                                                  smsCode:self.passcodeInputTextField.text
...
//            [[MaxChatIMClient sharedInstance] loginWithCurrentuserCompletion:nil];
